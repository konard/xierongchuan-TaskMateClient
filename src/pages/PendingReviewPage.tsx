 ...
 */
 ...
 <button
 className="w-full p-4 text-left rounded-xl border border-gray-200 hover:border-red-300 hover:bg-red-50"
 ...
 <button
 className="w-full p-4 text-left rounded-xl border border-gray-200 hover:border-blue-300 hover:bg-blue-50"
 onClick={() => {
 setRejectModal(null);
 setRejectReason('');
