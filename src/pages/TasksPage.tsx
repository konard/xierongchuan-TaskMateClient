...
export const TasksPage: React.FC = () => {
 ...
 const baseClasses ='bg-white rounded-xl shadow-sm border hover:shadow-md';
...
'overdue':'Просрочено',
 ...
 <div key={task.id} className={`p-5 rounded-xl border hover:shadow-sm ${getTaskCardClass(task)}`}>
