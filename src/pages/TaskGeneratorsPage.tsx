...
export const TaskGeneratorsPage: React.FC = () => {
 ...
 className={`p-5 rounded-xl border cursor-pointer ${generator.is_active
 ...
 disabled={pauseMutation.isPending || resumeMutation.isPending}
 className={`p-1.5 rounded-xl ${generator.is_active
 ...
 className="p-1.5 text-gray-400 hover:text-blue-600 hover:bg-blue-50 rounded-xl"
 title="Редактировать"
 >
