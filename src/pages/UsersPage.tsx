...
export const UsersPage: React.FC = () => {
 ...
 <div key={user.id} className={`p-4 sm:p-5 rounded-xl border hover:shadow-sm bg-white rounded-xl shadow-sm border hover:shadow-md border-gray-200`}>
 ...
 {usersData?.data.map((user) => (
 <div key={user.id} className={`p-4 sm:p-6 bg-white rounded-xl shadow-sm border hover:shadow-md border-gray-200`}>
 ...
 <button
 onClick={() => handleViewDetails(user)}
 className="text-left cursor-pointer hover:text-blue-600 hover:underline focus:outline-none focus:ring-2 focus:ring-blue-500 rounded w-full"
 >
