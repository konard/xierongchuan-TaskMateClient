...
export const ArchivedTasksPage: React.FC = () => {
 ...
 const baseClasses ='p-5 rounded-xl border hover:shadow-sm';
 ...
 task.archive_reason ==='completed' ?'border-green-200' :
 task.archive_reason ==='completed_late' ?'border-yellow-200' :
 task.archive_reason ==='expired' || task.archive_reason ==='expired_after_shift' ?'border-red-200' :''
 }`}>
 <Card.Body>
