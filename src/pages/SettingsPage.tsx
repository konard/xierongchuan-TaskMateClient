...
export const SettingsPage: React.FC = () => {
 ...
 maintenanceMode, originalMaintenanceMode, calendarHasPendingChanges,
 ...
 className={`w-full flex items-center px-4 py-3 text-sm font-medium rounded-xl ${activeTab === tab.id
 ...
 <div className="bg-gray-50 p-3 rounded-xl border border-gray-200 flex items-center">
 ...
 />
 <div className="w-16 h-10 flex items-center justify-center border border-gray-300 rounded-xl font-mono font-bold text-gray-700 bg-gray-50">
 ...
 className="w-20"
 />
 <span className="text-gray-500 text-sm">часов после закрытия смены</span>
 </div>
 ...
 <div className="flex items-center gap-4">
 <label className="text-sm font-medium text-gray-700">Время запуска:</label>
 <Input
 type="time"
 ...
 <div className="space-y-6">
 <div>
 <h2 className="text-xl font-semibold text-gray-900 mb-4">Календарь выходных дней</h2>
 ...
 <div className="flex items-center justify-between">
 <h4 className="font-medium text-gray-900">Расписание смен</h4>
 {selectedDealershipId && (
 <Button
 type="button"
 size="sm"
 ...
 <h4 className="font-medium text-gray-900 mb-4">Автоматизация смен</h4>
 <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
 <Card>
 <Card.Body>
 <Checkbox
 ...
 <Card>
 <Card.Body>
 <label className="block text-sm font-medium text-gray-900 mb-2">Напоминание о начале смены</label>
 <div className="flex items-center gap-3">
 <Input
 type="number"
 min={0}
 ...
 className="w-24"
 />
 <span className="text-gray-500 text-sm">минут до начала</span>
 </div>
 <p className="mt-2 text-xs text-gray-400">Система отправит уведомление сотруднику перед началом смены.</p>
 </Card.Body>
 </Card>
 </div>
 </div>
 ...
 <>
 <div className="text-sm font-medium text-gray-500 mt-2 mb-2">Типы уведомлений</div>
 {[
 ...
 <Card key={item.key} className="hover:border-blue-300 cursor-pointer">
 <Card.Body>
 <div className="flex items-center justify-between">
 <div>
 ...
 <WrenchIcon className="w-8 h-8 text-red-200 flex-shrink-0 ml-4" />
 </div>
 ...
 />
 {maintenanceMode && (
 <p className="mt-2 ml-7 text-xs text-red-600">
