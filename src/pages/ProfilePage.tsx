...
export const ProfilePage: React.FC = () => {
 ...
 className={`
 flex-1 flex items-center justify-center gap-2 py-2.5 px-3 sm:px-4 rounded-xl text-sm font-medium whitespace-nowrap
 ${isActive
...
`}
 ...
 <div className="p-3 bg-gray-50 rounded-xl border border-gray-200 text-gray-600 flex items-center gap-2">
 ...
 <div className="alert bg-yellow-50 border border-yellow-200 rounded-xl p-4 mb-6">
 ...
 <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-6">
 {/* Total Shifts */}
 <div className="bg-white p-5 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md relative overflow-hidden">
 ...
 <div className="text-sm font-medium text-gray-500">Всего смен</div>
 </div>
 <div className="text-3xl font-extrabold text-gray-900 pl-1 relative z-10">
 {shiftsData?.total || 0}
 </div>
 </div>
 ...
 <div className="bg-white p-5 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md relative overflow-hidden">
 <div className="absolute bottom-0 right-0 p-3 opacity-10">
 <BriefcaseIcon className="w-16 h-16 text-blue-600" />
 </div>
 <div className="flex flex-col items-start gap-3 mb-2 relative z-10">
 <div className="p-2 bg-blue-50 rounded-xl text-blue-600">
 ...
 <div className="text-xl font-bold text-gray-900 pl-1 capitalize truncate relative z-10">
 {user.role}
 </div>
 </div>
 ...
 <div className="text-sm font-medium text-gray-500">Опоздания</div>
 </div>
 <div className="text-3xl font-extrabold text-gray-900 pl-1 relative z-10">
 ...
 <div className="text-sm font-medium text-gray-500">Эффективность</div>
 </div>
 <div className="text-3xl font-extrabold text-gray-900 pl-1 relative z-10">
 ...
 <h3 className="text-lg font-semibold text-gray-900 mb-4">Выполнение в срок</h3>
 {(() => {
 ...
 const textColorClass = rate >= 80 ?'text-green-600' : rate >= 60 ?'text-yellow-600' :'text-red-600';
 ...
 <div
 className={`h-4 rounded-full ${bgColorClass}`}
 style={{ width:`${rate}%`}}
 />
 </div>
 ...
 <h3 className="text-lg font-semibold text-gray-900">Статистика задач (текущий месяц)</h3>
 </div>
 <div className="p-6">
 ...
 <h4 className="text-base font-medium text-gray-900">Нет активных задач</h4>
