 ...
 */
 ...
 <div className="inline-block align-bottom bg-white rounded-2xl text-left shadow-xl transform sm:my-8 sm:align-middle sm:max-w-2xl sm:w-full">
 <form onSubmit={handleSubmit}>
 <div className="bg-white px-6 pt-5 pb-4 rounded-t-2xl">
 ...
 <div>
 <label className="block text-sm font-medium text-gray-700 mb-2">Дни месяца</label>
 <MonthDayPicker
 ...
 <div className="bg-gray-50 px-4 py-3 sm:px-6 flex flex-col-reverse gap-2 sm:flex-row-reverse sm:gap-3 rounded-b-2xl [&>button]:w-full [&>button]:sm:w-auto">
 <Button
 type="button"
 variant="outline"
 onClick={onClose}
