...
export const GeneratorDetailsModal: React.FC<GeneratorDetailsModalProps> = ({
 ...
 <div className="h-8 w-8 rounded-full bg-blue-100 flex items-center justify-center text-blue-600 text-xs font-semibold mr-3">
 ...
 <h4 className="text-sm font-medium text-gray-500 uppercase tracking-wider mb-4 flex items-center">
 ...
 <>
 {/* All Time Chart */}
 <div className="flex flex-col sm:flex-row items-center gap-6 mb-6 p-4 bg-gradient-to-r from-gray-50 to-gray-100 rounded-xl">
 <DonutChart
 ...
 <h5 className="text-lg font-semibold text-gray-900 mb-3">За всё время</h5>
 <DonutChartLegend segments={getChartSegments(stats.all_time)} />
 {stats.all_time.total_generated > 0 && (
 <div className="mt-3 pt-3 border-t border-gray-200 text-sm text-gray-600">
 Вовремя: <span className="font-medium text-green-600">{stats.all_time.on_time_rate}%</span>
 </div>
 )}
 </div>
 </div>
