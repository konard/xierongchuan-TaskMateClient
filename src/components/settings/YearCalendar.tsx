...
const MonthCalendar: React.FC<MonthCalendarProps> = ({
 ...
 <div
 key={day}
 className={`text-center text-xs font-medium py-1 ${i >= 5 ?'text-orange-500' :'text-gray-500'
 }`}
 >
 {day}
 </div>
...
export const YearCalendar = forwardRef<YearCalendarRef, YearCalendarProps>(({
 ...
 Выходные: <strong className="text-gray-900">{holidaysData?.data?.count || 0}</strong>
 </span>
 </div>
 <div className="flex items-center gap-2">
 ...
 <p className="font-medium text-blue-800 mb-1">💡 Подсказка</p>
 <p>
