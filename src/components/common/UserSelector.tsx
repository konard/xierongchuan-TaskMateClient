...
export const UserSelector: React.FC<UserSelectorProps> = ({
 ...
 className={` block w-full rounded-xl border-gray-200 shadow-sm focus:outline-none focus:border-blue-500 sm:text-sm px-3 py-2 border disabled:bg-gray-100 disabled:cursor-not-allowed disabled:opacity-50 bg-white text-gray-900 ${className}`}
 >
 {isLoading ? (
