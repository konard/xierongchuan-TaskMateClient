...
export const ShiftPhotoViewer: React.FC<ShiftPhotoViewerProps> = ({
 ...
 {/* Error state */}
 {modalImageError && (
 <div className="w-full max-w-lg h-64 flex flex-col items-center justify-center bg-gray-100 rounded-lg">
 <svg className="w-16 h-16 text-gray-400 mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
 <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
 </svg>
 <p className="text-gray-500 mb-3">Ошибка загрузки изображения</p>
 <Button
 variant="secondary"
 size="sm"
...
const PhotoThumbnail: React.FC<PhotoThumbnailProps> = ({
 ...
 return (
 <div
 className={`relative ${sizeClasses} rounded-lg overflow-hidden bg-gray-100 border border-gray-200 hover:border-blue-500 flex-shrink-0 ${
