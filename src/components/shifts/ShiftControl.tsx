...
export const ShiftControl: React.FC = () => {
 ...
 <h2 className="text-sm font-semibold text-gray-900">Управление сменой</h2>
 {isShiftOpen ? (
 ...
 <span className="font-medium text-gray-900">{formatDateTime(currentShift.shift_start)}</span>
 </div>
 {currentShift.is_late && (
 <div className="flex items-center gap-2">
 <span className="text-red-500">Опоздание:</span>
 <span className="font-medium text-red-600">{currentShift.late_minutes} мин</span>
 </div>
 )}
 {currentShift.dealership && (
 <div className="flex items-center gap-2">
 <span className="text-gray-400">Автосалон:</span>
 <span className="font-medium text-gray-900">{currentShift.dealership.name}</span>
 </div>
 )}
...
'Выбрать фото'
 ...
 className="inline-flex items-center justify-center px-5 py-2 bg-red-600 text-white text-sm font-medium rounded-lg hover:bg-red-700 disabled:opacity-50 disabled:cursor-not-allowed shadow-sm whitespace-nowrap"
 >
...
'Выбрать фото'
 ...
 className="inline-flex items-center justify-center px-5 py-2 bg-green-600 text-white text-sm font-medium rounded-lg hover:bg-green-700 disabled:opacity-50 disabled:cursor-not-allowed shadow-sm whitespace-nowrap"
 >
