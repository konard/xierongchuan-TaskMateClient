...
export const Pagination: React.FC<PaginationProps> = ({
 ...
 const baseButtonClasses ='relative inline-flex items-center px-2 py-2 text-sm font-medium focus:z-20 focus:outline-offset-0 disabled:opacity-50';
 const activeClasses ='z-10 bg-blue-600 text-white focus:ring-2 focus:ring-offset-2 focus:ring-blue-500';
 const inactiveClasses ='text-gray-900 ring-1 ring-inset ring-gray-300 hover:bg-gray-50 bg-white';
