...
const FileIcon: React.FC<{ mimeType: string }> = ({ mimeType }) => {
 ...
 return (
 <div className={`${baseClass} bg-purple-100 rounded p-1.5`}>
 ...
 return (
 <div className={`${baseClass} bg-pink-100 rounded p-1.5`}>
 <svg className="w-full h-full text-pink-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
 ...
 return (
 <div className={`${baseClass} bg-red-100 rounded p-1.5`}>
 ...
 return (
 <div className={`${baseClass} bg-yellow-100 rounded p-1.5`}>
 ...
 return (
 <div className={`${baseClass} bg-blue-100 rounded p-1.5`}>
