...
export const IconButton: React.FC<IconButtonProps> = ({
 ...
 const baseClasses ='inline-flex items-center justify-center rounded-lg focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:opacity-50 disabled:cursor-not-allowed';
