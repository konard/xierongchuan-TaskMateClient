...
const variantClasses: Record<ButtonVariant, string> = {
 ...
 outline:'bg-white text-gray-700 hover:bg-gray-50 border-gray-300 shadow-sm',
 warning:'bg-yellow-500 text-white hover:bg-yellow-600 border-transparent shadow-sm',
};
...
export const Button: React.FC<ButtonProps> = ({
 ...
 const baseClasses ='inline-flex items-center justify-center font-medium rounded-lg border focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:opacity-50 disabled:cursor-not-allowed';
