...
export const ArchivedTaskDetailsModal: React.FC<ArchivedTaskDetailsModalProps> = ({
 ...
 <div className="h-8 w-8 rounded-full bg-blue-100 flex items-center justify-center text-sm font-semibold text-blue-700 mr-3">
 ...
 <p className="text-sm text-gray-600 italic border-l-2 border-gray-300 pl-2 mb-2">
 {userResponse.comment}
 </p>
 )}
