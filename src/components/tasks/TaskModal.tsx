...
export const TaskModal: React.FC<TaskModalProps> = ({ isOpen, onClose, task }) => {
 ...
 const selectorClassName =' block w-full rounded-xl border-gray-200 shadow-sm focus:border-blue-500 sm:text-sm px-3 py-2 border bg-white text-gray-900 focus:outline-none';
 ...
 />
 {errors.dealership_id && <p className="mt-1 text-sm text-red-600">{errors.dealership_id.message}</p>}
 </div>
