...
const ProofThumbnail: React.FC<ProofThumbnailProps> = ({ proof, onClick, onDelete }) => {
 ...
 <div
 onClick={onClick}
 className="relative aspect-square rounded-lg overflow-hidden bg-gray-100 cursor-pointer border border-gray-200 hover:border-blue-500"
 >
 {isImage ? (
 <img
 src={proof.url}
 ...
 className="absolute -top-2 -right-2 p-1 bg-red-500 text-white rounded-full opacity-0 group-hover:opacity-100 hover:bg-red-600"
 >
...
const ProofPreview: React.FC<ProofPreviewProps> = ({ proof }) => {
 ...
 if (isAudio) {
 return (
 <div className="w-full max-w-md p-6 bg-gray-100 rounded-lg">
