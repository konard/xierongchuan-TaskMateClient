...
export const TaskDetailsModal: React.FC<TaskDetailsModalProps> = ({
 ...
 <div key={assignment.id} className="p-3 rounded-lg border border-gray-200 bg-white">
 ...
 {/* Кнопки верификации */}
 {canVerify && (
 <div className={hasUserProofs ?"mt-3" :"mt-2 pt-2 border-t border-gray-100"}>
 <VerificationPanel
 ...
 <div className={hasProofs ?"mt-3" :"mt-2 pt-2 border-t border-gray-100"}>
 <VerificationPanel
